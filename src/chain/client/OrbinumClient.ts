...
export class OrbinumClient {
    ...
    /**
     * Typed access to `zkVerifier_*` custom RPC endpoints — the chain's
     * supported circuit versions and their VK hashes. A custody host composes
     * its circuit-version resolver over this; the public SDK does not, since
     * resolving pulls in the prover.
     */
