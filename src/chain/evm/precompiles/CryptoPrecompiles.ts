...
export class CryptoPrecompiles {
     ...
     *
     * SECURITY: the scalar leaves this process — it is sent to the node in the
     * `eth_call`. Never pass a SECRET scalar (a spending key, a viewing secret):
     * that discloses it to whoever runs the RPC. This precompile is for public
     * curve math; secret-scalar multiplication belongs in the wallet, off-node.
     */
