 ...
 *
 * Public, though it was written for shielded ops: nothing here touches a note,
 * a key or a vault. The chain-side question is entirely the caller's `landed()`,
 * and a dropped WebSocket between submit and finalization is a plain Substrate
 * problem — a balance transfer meets it exactly as a shield does.
 */
